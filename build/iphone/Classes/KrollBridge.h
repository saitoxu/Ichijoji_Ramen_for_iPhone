...
@interface IchijojiRamenObject : KrollCoverageObject {
#else
@interface IchijojiRamenObject : KrollObject {
#endif
@private
...
extern NSString * IchijojiRamen$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	IchijojiRamenObject *_ichijojiramen;
    KrollObject* console;
	BOOL shutdown;
