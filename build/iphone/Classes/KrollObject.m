 ...
 * Copyright (c) 2009-2011 by IchijojiRamen, Inc. All Rights Reserved.
...
//@interface IchijojiRamenObject : NSObject
//@end

@interface IchijojiRamenObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[IchijojiRamenObject class]])
		{
			for (NSString *key in [[(IchijojiRamenObject*)o modules] allKeys])
			{
