...
// in simulator we redefine to format for IchijojiRamen Developer console
...
{\
	NSString * exceptionName = [@"org.ichijojiramen." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.ichijojiramen";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	TiExceptionThrowWithNameAndReason(exceptionName,message);\
}\
...
enum {
	UIIchijojiRamenNativeItemNone = -1, 
	UIIchijojiRamenNativeItemSpinner = -2,
	UIIchijojiRamenNativeItemProgressBar = -3,
	
	UIIchijojiRamenNativeItemSlider = -4,
	UIIchijojiRamenNativeItemSwitch = -5,
	UIIchijojiRamenNativeItemMultiButton = -6,
	UIIchijojiRamenNativeItemSegmented = -7,
	
	UIIchijojiRamenNativeItemTextView = -8,
	UIIchijojiRamenNativeItemTextField = -9,
	UIIchijojiRamenNativeItemSearchBar = -10,
	
	UIIchijojiRamenNativeItemPicker = -11,
	UIIchijojiRamenNativeItemDatePicker = -12,
	
	UIIchijojiRamenNativeItemInfoLight = -13,
	UIIchijojiRamenNativeItemInfoDark = -14,
	
	UIIchijojiRamenNativeItemDisclosure = -15,
	
	UIIchijojiRamenNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all IchijojiRamen instances of
