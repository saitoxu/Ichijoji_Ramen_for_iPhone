...
//Rare exceptions to indicate a bug in the _ichijojiramen code (Eg, function that a subclass should have implemented)
...
/**
 The base class for IchijojiRamen proxies.
 */
