...
/**
 Base class for all IchijojiRamen views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the IchijojiRamen view hierarchy (such as wrapped iOS UIViews) was touched.
